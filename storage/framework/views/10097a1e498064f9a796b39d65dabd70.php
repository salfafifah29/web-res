...
<body>
        ...
        <nav class="navbar">
            <div class="logo">
                <div class="header-logo">
                    <img src="<?php echo e(asset('image/logo sushi.png')); ?>" alt="logo sushi">
                    <h1>SUSHI SHO</h1>
                </div>
            </div>
    ...
    <main class="mt-6">
        <section id="home" class="home">
            <div class="history">
                <img src="<?php echo e(asset('image/sushi png (3).png')); ?>" alt="sushi png (3)">
                <h2>SUSHI SHO</h2>
        ...
        <section id="about" class="about">
            <div class="about">
                <img src="<?php echo e(asset('image/restoran (6).jpeg')); ?>" alt="">
                <h2>RESTAURANT</h2>
...
</html><?php /**PATH C:\xampp\htdocs\newwebsite\resources\views/welcome.blade.php ENDPATH**/ ?>